#!/usr/bin/env bash
#
# Build and preview the E7Unity documentation site with DocFX.
#
...
#   3. Open src/E7Unity in Unity once so it generates the .sln / .csproj
...
watch_dirs=(
  ...
  "$repo_root/src/E7Unity/Assets/E7Unity/Documentation~"
  "$repo_root/src/E7Unity/Assets/E7Unity/CHANGELOG.md"
)
